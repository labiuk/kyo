<main class="container mx-auto max-w-screen-lg h-full">
    ...
    <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
        <!-- overlay -->
        <div id="overlay" class="w-full h-full absolute top-0 left-0 pointer-events-none z-50 flex flex-col items-center justify-center rounded-md hidden">
            <i>
        ...
        <footer class="flex justify-end pt-4">
            <form wire:submit.prevent="upload" enctype="multipart/form-data">
                <input id="hidden-input" wire:model="images" type="file"multiple />
                <button id="submit" type="submit" class="upload">
                    Upload now
                </button>
...
<template id="image-template">
    <li class="block p-1 w-1/5 h-200">
